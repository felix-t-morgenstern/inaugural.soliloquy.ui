...
public abstract class AbstractContentSpanDefinition extends AbstractContentDefinition {
    ...
    public AbstractProviderDefinition<Vertex> renderingLocDef;

    protected AbstractContentSpanDefinition(AbstractProviderDefinition<Vertex> renderingLocDef,
                                            float length,
                                            int z,
                                            UUID uuid) {
        super(z, uuid);
        this.renderingLocDef = renderingLocDef;
