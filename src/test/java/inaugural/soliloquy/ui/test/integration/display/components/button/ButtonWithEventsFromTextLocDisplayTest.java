...
public class ButtonWithEventsFromTextLocDisplayTest extends DisplayTest {
    public static void main(String[] args) {
        new DisplayTest().runTest(
                "Button with events from text loc display test",
                ...
                () -> DisplayTest.runThenClose("Button with events from text loc", 16000),
                ButtonWithEventsFromTextLocDisplayTest::populateTopLevelComponent
        );
    }
