...
public class ScrollbarVerticalWithArrowButtonsDisplayTest extends DisplayTest {
    ...
    public static void main(String[] args) {
        new DisplayTest().runTest(
                "Scrollbar vertical with arrows display test",
                ...
                () -> DisplayTest.runThenClose("Scrollbar vertical with arrows", 60000),
                ScrollbarVerticalWithArrowButtonsDisplayTest::populateTopLevelComponent
        );
    }
